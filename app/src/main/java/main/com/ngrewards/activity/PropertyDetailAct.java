...
import main.com.ngrewards.merchant_fragment.FloorPlanFragment;
...
import main.com.ngrewards.merchant_fragment.MerchantPropertyAboutFrag;
import main.com.ngrewards.merchant_fragment.MerchantPropertyOffersFrag;
import main.com.ngrewards.merchant_fragment.MerchantPropertyReviewsFrag;
...
public class PropertyDetailAct  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(PropertyDetailAct.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PropertyDetailAct.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        ...
        mySession = new MySession(PropertyDetailAct.this);
        ...
        if (bundle != null) {
            ...
            if (merchant_img_str != null && !merchant_img_str.equalsIgnoreCase("") && !merchant_img_str.equalsIgnoreCase(BaseUrl.image_baseurl)) {
                Glide.with(PropertyDetailAct.this).load(merchant_img_str).placeholder(R.drawable.placeholder).into(user_img);
    ...
    private void clickevent() {
        ...
        paybill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PropertyDetailAct.this, ManualActivity.class);
    ...
    private void idinita() {
        ...
        messagess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PropertyDetailAct.this, MemberChatAct.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        PropertyDetailAct.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new MerchantPropertyAboutFrag(), getResources().getString(R.string.about));
        adapter.addFragment(new FloorPlanFragment(merchant_id,"Residential","1"), getResources().getString(R.string.floor_plan));
        adapter.addFragment(new MerchantPropertyOffersFrag(), getResources().getString(R.string.offers));
        adapter.addFragment(new MerchantPropertyReviewsFrag(), getResources().getString(R.string.reviews));
    ...
    private void checkGps() {
        gpsTracker = new GPSTracker(PropertyDetailAct.this);
    ...
    private void fingerPrintLay() {
        final Dialog dialogSts = new Dialog(PropertyDetailAct.this, R.style.DialogSlideAnim);
                ...
                if (!fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    if (!keyguardManager.isKeyguardSecure()) {
                        ...
                        if (cipherInit()) {
                            ...
                            FingerprintHandler helper = new FingerprintHandler(PropertyDetailAct.this, textView, "Payment");
