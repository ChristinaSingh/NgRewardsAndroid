...
public class ManualActivity extends AppCompatActivity {
        ...
        if (user_log_data == null) {
            ...
            try {
                ...
                if (message.equalsIgnoreCase("1")) {
                    ...
                    Log.e("user profile data===",jsonObject1.toString());
        ...
        applytv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  card_amount_tv.setText(String.format("%.2f", new BigDecimal(tot)));
                ...
                total_amt.setText(mySession.getValueOf(MySession.CurrencySign) + " " + String.format("%.2f", tot));
                card_amount_tv.setText(String.format("%.2f", tot));
                ...
                if (applytv.getText().toString().equalsIgnoreCase(getResources().getString(R.string.applied))) {
                   ...
                   // card_amount_tv.setText(String.format("%.2f", new BigDecimal(amt)));
                     card_amount_tv.setText(String.format("%.2f",amt));
            ...
            public void afterTextChanged(Editable s) {
                ...
                try {
                   // card_amount_tv.setText(String.format("%.2f", new BigDecimal(total_amount_due)));
                    card_amount_tv.setText(String.format("%.2f", Double.parseDouble(total_amount_due)));
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            registerReceiver(broadcastReceiver, new IntentFilter("Unseen Count"),Context.RECEIVER_EXPORTED);
