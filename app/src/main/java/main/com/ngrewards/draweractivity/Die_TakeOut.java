...
*/
    ...
    private void ApiUpdateUser() {
        ...
        Toast.makeText(this, employyee_id_string, Toast.LENGTH_SHORT).show();
        Call<ResponseBody> call = ApiClient.getApiInterface().ApiUpdateUser(user_id, Afflited_name_String, employyee_id_string ,"0");
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
...
*/
    ...
    private void AddUpdateTax(String editTextString) {
        Call<ResponseBody> call = ApiClient.getApiInterface().AddUpdateTaxApi( user_id, editTextString ,"0");
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
...
*/
    ...
    private void AddUpdateDelvery(String editTextString, String strPerorFix) {
        Call<ResponseBody> call = ApiClient.getApiInterface().AddUpdateDelveryApi( user_id, editTextString , strPerorFix ,"0");
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
...
*/
    ...
    private void MenuItemApiCAll() {
        Call<ResponseBody> call = ApiClient.getApiInterface().MenuItemApiCAll(user_id, "0");
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    try {
                        ...
                        tax_amount = object.getString("tax");
