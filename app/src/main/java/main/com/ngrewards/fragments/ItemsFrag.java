...
public class ItemsFrag extends Fragment {
    ...
    private String user_id = "", rating_filter_str = "", fill_category_id = "", price_type_str = "", fill_category_id_loc = "", subCategoryId = "";
    ...
    private void getSoldItems() {
        ...
        Call<ResponseBody> call = ApiClient.getApiInterface().getFeaturedProduct(user_id, fill_category_id, price_type_str, rating_filter_str, subCategoryId);
                    ...
                    try {
                        ...
                        if (object.getString("status").equals("1")) {
                            ...
                            if(!subCategoryId.equalsIgnoreCase("")){
                                for(int i = 0;i<successData.getResult().size();i++){
                                    if(successData.getResult().get(i).getMember_eligible_to_see().equalsIgnoreCase("Yes")){
                                        soldItemListArrayList.add(successData.getResult().get(i));
                                    }
                                }
                                subCategoryId="";
                            }else {
    ...
    private void filterlay() {
        ...
        Spinner sub_category_spinner = dialogSts.findViewById(R.id.sub_category_spinner);
