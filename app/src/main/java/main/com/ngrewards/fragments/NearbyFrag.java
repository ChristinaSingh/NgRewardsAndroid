...
public class NearbyFrag extends Fragment {
            ...
            fusedLocationClient.getLastLocation()
                    .addOnSuccessListener(requireActivity(), new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            if (location != null) {
                                ...
                                Log.e("REFRESH_LOCATION ", " >> " + latitude + " , " + longitude);
                    ...
                    .addOnFailureListener(requireActivity(), new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            // Handle failure
                            Log.e("Near by", "Error trying to get last GPS location", e);
                        }
                    });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode) {
            ...
            // Add other 'case' lines to handle other permissions your app might request.
            // You can add as many as you want here as long as you handle them in 'onRequestPermissionsResult'
        }
    }
