...
public class MerchantPropertyOffersFrag extends Fragment {
    ...
    public MerchantPropertyOffersFrag() {
    ...
    private void getOffers() {
        ...
        Log.e("DATA >", ">" + PropertyDetailAct.merchant_id + " >> " + user_id);
        Call<ResponseBody> call = ApiClient.getApiInterface().getMemberMerchnatOffer(PropertyDetailAct.merchant_id, user_id);
