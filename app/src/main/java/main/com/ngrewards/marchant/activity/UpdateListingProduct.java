...
public class UpdateListingProduct extends AppCompatActivity {
    ...
    private String user_id = "", stock_str = "", shipping_price_str = "", tital_name_str = "", description_str = "", price_str = "", sizes_str = "", colors_str = "", shipping_str = "",shipping_quantity_str = "",shipping_percentage_str = "",sku_str="";
    ...
    private void clickevent() {
        ...
        update_item_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                shipping_quantity_str = edShippingQuantity.getText().toString();
                ...
                if (tital_name_str == null || tital_name_str.equalsIgnoreCase("")) {
                    ...
                    Toast.makeText(UpdateListingProduct.this, getResources().getString(R.string.enter_shiping_quantity), Toast.LENGTH_LONG).show();

                }

                else if (shipping_percentage_str == null || shipping_percentage_str.equalsIgnoreCase("")) {
                    Toast.makeText(UpdateListingProduct.this, getResources().getString(R.string.enter_shiping_percentage), Toast.LENGTH_LONG).show();

                }

                else if (Integer.parseInt(shipping_percentage_str.trim()     )>99) {
                    Toast.makeText(UpdateListingProduct.this, getResources().getString(R.string.percentage_enter_only_two_digit), Toast.LENGTH_LONG).show();
...
//Toast.makeText(UpdateListingProduct.this,getResources().getString(R.string.inworking),Toast.LENGTH_LONG).show();
    ...
    private void idinti() {
        ...
        edShippingQuantity = findViewById(R.id.edShippingQuantity);
        edShippingPercentage = findViewById(R.id.edShippingPercentage);
        ...
        if (ActiveProductsAct.product_item_detail != null) {
            ...
            edShippingQuantity.setText("" + ActiveProductsAct.product_item_detail.getFreeShipping());
            edShippingPercentage.setText("" + ActiveProductsAct.product_item_detail.getShippingPercentage());
            sku_et.setText("" + ActiveProductsAct.product_item_detail.getSkuOptional());
    ...
    public class UpdateProductsAsc extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                multipart.addFormField("sku_optional",sku_str);
                ...
                multipart.addFormField("free_shipping", shipping_quantity_str);
                multipart.addFormField("shipping_percentage", shipping_percentage_str);
