...
*/
    ...
    private void APIStatusPublish( String id_item) {
        Call<ResponseBody> call = ApiClient.getApiInterface().APIStatusPublish(id_item, "publish", "0");
...
*/
    ...
    private void APIStatusHide(String id_item) {
        Call<ResponseBody> call = ApiClient.getApiInterface().APIStatusHide(id_item, "hide", "0");
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
...
*/
    ...
    private void APIStatusHide1(int i, String id_item) {
        Call<ResponseBody> call = ApiClient.getApiInterface().APIStatusHide1(id_item);
        call.enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                if (response.isSuccessful()) {
