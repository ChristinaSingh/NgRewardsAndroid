...
public class QrCodeFragment extends Fragment {
    ...
    protected void attachBaseContext(Context base) {
        super.getActivity().attachBaseContext(LocaleHelper.onAttach(base));
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.activity_qr_code, container, false);
    ...
    private void initData() {
        ...
        mHandler = new QrCodeActivity.WeakHandler(this);
    }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        try {
            ...
            Toast.makeText(getActivity(), getString(R.string.qr_code_camera_not_found), Toast.LENGTH_SHORT).show();
            finish();
            return;
        } catch (RuntimeException re) {
            re.printStackTrace();
            mDecodeManager.showPermissionDeniedDialog(getActivity());
            return;
        }
        mQrCodeFinderView.setVisibility(View.VISIBLE);
        mSurfaceView.setVisibility(View.VISIBLE);
        mLlFlashLight.setVisibility(View.VISIBLE);
        root.findViewById(R.id.qr_code_view_background).setVisibility(View.GONE);
        if (mCaptureActivityHandler == null) {
            mCaptureActivityHandler = new CaptureActivityHandler(getActivity());
        }
    }
...
*//*
    ...
    public void handleDecode(Result result) {
        ...
        if (null == result) {
            mDecodeManager.showCouldNotReadQrCodeFromScanner(getActivity(), () -> restartPreview());
        } else {
...
/*   String mername = jsonObject.getString("murchant_name");
                if (jsonObject.getString("murchant_name") != null && !jsonObject.getString("murchant_name").equalsIgnoreCase("")) {
                    ...
                    if (country_id.equalsIgnoreCase("")) {
                        ...
                        getActivity().onBackPressed();
                        Toast.makeText(getActivity(), "Invalid Country!!!", Toast.LENGTH_SHORT).show();
