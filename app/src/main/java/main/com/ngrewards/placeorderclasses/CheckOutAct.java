...
public class CheckOutAct extends AppCompatActivity {
        ...
        place_order_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cartListBeanArrayList == null || cartListBeanArrayList.isEmpty()) {
                  Toast.makeText(CheckOutAct.this,getString(R.string.please_add_item),Toast.LENGTH_LONG).show();
                } else {
                    product_id_comma = "";
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            registerReceiver(broadcastReceiver, new IntentFilter("Unseen Count"), Context.RECEIVER_NOT_EXPORTED);
        }
        else {
    ...
    public class MycartAdapterExpand extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (PreferenceConnector.readString(CheckOutAct.this, PreferenceConnector.Category_id, "").equalsIgnoreCase("1016")) {
                ...
                mainprice.setText(mySession.getValueOf(MySession.CurrencySign) +String.valueOf(itemTotal));
            ...
            if (result == null) {
                ...
                try {
                    ...
                    if (message.equalsIgnoreCase("1")) {
                        ...
                        member_ngcash = jsonObject1.getString("member_ngcash");
                        if (member_ngcash == null ||member_ngcash.equalsIgnoreCase("0") || member_ngcash.equalsIgnoreCase("null") || member_ngcash.equalsIgnoreCase("") || member_ngcash.equalsIgnoreCase("0.0")) {
                            avbngcash.setText(mySession.getValueOf(MySession.CurrencySign) + "0.00 Available");
                        } else {

                            avbngcash.setText(mySession.getValueOf(MySession.CurrencySign) + member_ngcash + " Available");
                            ngcash_val = Double.parseDouble(member_ngcash);
                        }
                    }
